...
// Current version 6/9/22 is just for testing and not database ready
@Service
public class PostServiceStubImpl implements PostService {
    private List<Post> posts = new ArrayList<Post>() {{
        add(new Post(1L, "First Post ", "Second post content:<ul><li>line 1</li><li>line 2</li></p>", new User(10L, "Someone", "Travis Taylor")));
        add(new Post(2L, "Second Post ",
                "Second post content:<ul><li>line 1</li><li>line 2</li></p>",
                new User(10L, "pesho10", "Peter Ivanov")));
        add(new Post(3L, "Third Post ", "<p>The post number 3 nice</p>",
                new User(10L, "merry", null)));
        add(new Post(4L, "Forth Post ", "<p>Not interesting post</p>", null));
        add(new Post(5L, "Fifth Post ", "<p>Just posting</p>", null));
